...
const page = () => {
  ...
  return (
    <AkpagerLayout header={8} footer={8} bodyClass={"home-eight"}>
      {/* Hero area start */}
      <section className="hero-area-eight pt-250 rpt-150 pb-220 rel z-1">
      ...
      {/* Hero area End */}
      {/* Counter Area Start */}
      <section className="counter-area bg-black pt-130 rpt-100 pb-85 rpb-55">
      ...
      {/* Features Area End */}
      {/* About Area Start */}
      <section className="about-eight-area pt-95 pb-105 rpb-75 rel z-1">
        <div className="container">
      ...
      <section className="services-box-area pb-100 rpb-70 rel z-1">
        <div className="container">
      ...
      {/* FAQ Area Start */}
      <section className="faq-eight-area py-130 rpy-100 rel z-1">
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div
      ...
      <section className="testimonials-area bg-black py-130 rpy-100 rel z-1">
        <div className="container">
          <div className="row justify-content-center">
