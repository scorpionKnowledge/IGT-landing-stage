...
const page = () => {
  return (
    <AkpagerLayout>
      <PageBanner pageName={"Shop"} pageTitle={"Shop Page"} />
            ...
            <div className="col-lg-3">
              <div className="shop-sidebar rmb-75">
                ...
                >
                  ...
                  <ul>
                    <li>
                      <div className="image">
                        <img
                          src="assets/images/widget/product1.jpg"
                          alt="Product"
                        />
                      </div>
                    ...
                    <li>
                      <div className="image">
                        <img
                          src="assets/images/widget/product2.jpg"
                          alt="Product"
                        />
                      </div>
                      <div className="content">
                    ...
                    <li>
                      <div className="image">
                        <img
                          src="assets/images/widget/product3.jpg"
                          alt="Product"
                        />
                      </div>
                      <div className="content">
                ...
                <div
                  ...
                  data-aos-offset={50}
                >
                  <h5>Boost your Digital Product marketing?</h5>
