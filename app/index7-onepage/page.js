...
const page = () => {
  ...
  return (
    <AkpagerLayout header={7} footer={7} bodyClass={"home-seven"} onePage>
      {/* Hero area start */}
      <section
        id="home"
        className="hero-area-seven pt-140 rpt-150 pb-70 rel z-1 bgc-lighter"
      >
      ...
      <section
        id="about"
        className="about-area pt-95 rpt-65 pb-130 rpb-100 rel z-1"
      >
        <div className="container">
      ...
      <section
        id="features"
        className="pricing-area-seven-one bgc-black rel z-1 py-130 rpy-100"
      >
        <div className="container">
          <div className="row justify-content-center">
      ...
      <section
        id="pricing"
        className="pricing-area-seven-two bgc-lighter color-five pt-125 rpt-95 pb-100 rpb-70 rel z-1"
      >
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-xl-7 col-lg-9 col-md-11">
      ...
      <section
        id="testimonials"
        className="testimonials-area-seven pt-120 rpt-100 rel z-1"
      >
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-6">
      ...
      <section
        id="faqs"
        className="faqs-area-seven pt-125 rpt-95 pb-115 rpb-85 rel z-1"
      >
        <div className="container">
          <div className="row justify-content-center">
            <div
