...
const page = () => {
  ...
  return (
    <AkpagerLayout header={3} footer={3} bodyClass={"home-three"}>
      {/* Hero area start */}
      <section
      ...
      {/* Tab Area Start */}
      <section className="tab-area-two bgc-lighter pt-125 rpt-105">
        <div className="container">
      ...
      <section className="what-we-offer-area bgc-lighter pt-100 rpt-80 pb-90 rpb-70">
        <div className="container">
          <div
            className="row justify-content-center"
            data-aos="fade-up"
      ...
      <section className="testimonials-area bg-dark py-120 rpy-100">
        <div className="container">
          <div className="row justify-content-center">
            <div
      ...
      {/* FAQs Area Start */}
      <section className="faqs-area bgc-lighter pt-125 rpt-105 pb-105 rpb-85">
        <div className="container">
