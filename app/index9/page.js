...
const page = () => {
  return (
    <AkpagerLayout header={9} footer={9} bodyClass={"home-nine"}>
      {" "}
      {/* Hero area start */}
      <section className="hero-area-nine pt-165 rpt-150 pb-130 rpb-100 rel z-1">
      ...
      {/* Tab Area End */}
      {/* Services Area Start */}
      <section className="service-area-nine bgc-black pt-130 rpt-100 pb-100 rpb-70">
        <div className="container">
          <div className="row justify-content-center">
      ...
      {/* Services Area End */}
      {/* About Area Start */}
      <section className="about-area-nine bgc-black pb-110 rpb-80 rel z-1">
        <div className="container">
      ...
      <section className="feature-image-box-area pt-130 rpt-100 pb-100 rpb-70">
        <div className="container">
          <div className="row justify-content-center">
      ...
      {/* Tooltip Area End */}
      {/* Pricing Area Start */}
      <section className="pricing-area bg-white pt-220 rpt-150 pb-100 rpb-70 rel">
        <div className="container">
      ...
      <section className="testimonials-nine-area py-130 rpy-100 rel z-1">
        <div className="container">
          <div className="row justify-content-center">
