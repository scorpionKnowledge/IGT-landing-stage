...
const page = () => {
  return (
    <AkpagerLayout header={6} footer={6} bodyClass={"home-six"} onePage>
      <section
        id="home"
        className="hero-area-six bgc-primary pt-215 rpt-150 pb-100 rel z-1"
      >
      ...
      <div
        ...
        style={{
          backgroundImage: "url(assets/images/backgrounds/hero-bg-six.png)",
        }}
      >
        <div
          ...
          data-aos-offset={50}
        >
          <img src="assets/images/hero/hero-six.png" alt="Hero" />
        </div>
      </div>
      {/* Hero Image Part End */}
      ...
      <section
        id="features"
        className="numbered-box-area rel pt-130 rpt-100 rel z-2"
      >
        <div className="container">
          <div className="row justify-content-center">
        ...
        <div className="container">
          ...
          <div className="row">
            ...
            >
              <div className="iconic-box style-ten">
                <div className="icon">
                  <i className="flaticon-payment-gateway" />
                </div>
                <div className="content">
                  <h5>
      ...
      <section
        id="ai"
        className="artificial-intelligence-area rel pt-50 rpt-20 pb-130 rpb-100 z-2"
      >
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-xl-7 col-lg-9 col-md-11">
      ...
      <section
        id="statistics"
        className="counter-area-six bgc-primary rel pt-130 rpt-100"
      >
        <div className="container">
          <div className="row justify-content-center">
      ...
      <section
        id="pricing"
        className="pricing-area-six bgc-lighter overflow-hidden rel z-1 pt-125 rpt-95 pb-100 rpb-70"
      >
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-xl-7 col-lg-9 col-md-11">
