...
const page = () => {
  ...
  return (
    <AkpagerLayout header={4} footer={4} bodyClass={"home-four"}>
      {/* Hero area start */}
      <section className="hero-area-four bg-black pt-250 rpt-150 pb-120 rpb-70 rel z-1">
      ...
      {/* About area start */}
      <section className="about-area-four pt-120 rpt-100">
        <div className="container">
      ...
      <section className="special-features-area pt-100 rpt-80">
        <div className="container">
      ...
      <section className="testimonials-area-four bg-black py-120 rpy-100">
        <div className="container">
          <div className="row justify-content-center">
      ...
      {/* Blog Area Start */}
      <section className="blog-area-four pb-90 rpb-70">
        <div className="container">
          <div className="row justify-content-center">
            <div
